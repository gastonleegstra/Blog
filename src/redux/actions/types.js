...
export const GET_SEARCH_BLOG_PAGINATION_SUCCESS = 'GET_SEARCH_BLOG_PAGINATION_SUCCESS';
export const GET_SEARCH_BLOG_PAGINATION_FAIL = 'GET_SEARCH_BLOG_PAGINATION_FAIL';